    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full rounded-lg bg-primary-800/50 border border-primary-600 text-white 
            placeholder-primary-400 focus:border-indigo-400 focus:ring-indigo-400
